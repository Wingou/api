...
var $author$project$Main$config = function (selectedEnv) {
	switch (selectedEnv.$) {
		...
		case 'PREPROD':
			return {defaultOperation: '', server: 'http://mediaapi-pp.vpback.vpgrp.io/api/v1'};
		default:
...
var $author$project$Main$emptyOperation = {masterMode: 'NONE', operationCode: 'OPERATION0', operationId: -1};
var $author$project$Main$emptyResponseApi = {data: 'Empty', status: 0, success: false};
var $author$project$Main$emptyTask = {creation_date: '', id: -1, master_mode: '', modification_date: '', processed_by: '', reprise_type: '', status: '', user_validator: ''};
var $author$project$Main$emptyWorkflow = {created: '', id: '-1', started: '', status: 'INIT', user: 'Nobody'};
...
var $author$project$Main$GotAbortTask = function (a) {
	return {$: 'GotAbortTask', a: a};
};
...
var $author$project$Main$apiHeader = _List_fromArray(
	[
		A2($elm$http$Http$header, 'Authorization', 'Basic c3ZjX21lZGlhdGFza3NAb3JlZGlzLXZwLmxvY2FsOnBXTlpPJzkuWFJ3Rg==')
	]);
...
var $author$project$Main$ResponseApi = F3(
	function (success, status, data) {
		return {data: data, status: status, success: success};
	});
...
var $author$project$Main$deleteTaskDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$ResponseApi,
...
var $author$project$Main$Operation = F3(
	function (operationId, operationCode, masterMode) {
		return {masterMode: masterMode, operationCode: operationCode, operationId: operationId};
	});
var $author$project$Main$operationDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$Operation,
...
var $author$project$Main$Task = F8(
	function (id, user_validator, status, processed_by, reprise_type, creation_date, modification_date, master_mode) {
		return {creation_date: creation_date, id: id, master_mode: master_mode, modification_date: modification_date, processed_by: processed_by, reprise_type: reprise_type, status: status, user_validator: user_validator};
	});
var $elm$json$Json$Decode$map8 = _Json_map8;
var $author$project$Main$taskDecoder = A9(
	$elm$json$Json$Decode$map8,
	$author$project$Main$Task,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'user_validator', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'status', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'processed_by', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'reprise_type', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'creation_date', $elm$json$Json$Decode$string),
...
var $author$project$Main$Workflow = F5(
	function (id, status, user, created, started) {
		return {created: created, id: id, started: started, status: status, user: user};
	});
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Main$workflowDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$Workflow,
...
var $author$project$Main$workflowsDecoder = A2(
...
var $author$project$Main$toAntiMasterMode = function (masterMode) {
	switch (masterMode) {
		case 'DAM':
			return 'NAS';
		case 'NAS':
		...
		switch (msg.$) {
			...
			case 'SetOperationInput':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'CallGetTasks':
				return model.displayTasks ? _Utils_Tuple2(
					_Utils_update(
						model,
						{displayTasks: false, messageUser: ''}),
			...
			case 'CallGetWorkflows':
				return model.displayWorkflows ? _Utils_Tuple2(
					_Utils_update(
						model,
						{displayWorkflows: false, messageUser: ''}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'GotOperation':
				var r = msg.a;
				var gotOperation = function () {
					if (r.$ === 'Ok') {
						var opeOk = r.a;
						return opeOk;
					} else {
						return $author$project$Main$emptyOperation;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'GotDeleteTask':
				...
				var gotResponseApi = function () {
					if (r.$ === 'Ok') {
						...
						return $author$project$Main$emptyResponseApi;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$displayCallMasterMode = F3(
	function (op, lastTask, display) {
		var statusOfLastTask = lastTask.status;
		var masterModeStr = op.masterMode;
		...
		return A2(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'display', displayMode)
				]),
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$Main$SetOperationInput),
						$elm$html$Html$Attributes$value(opInput),
						$elm$html$Html$Attributes$placeholder('OperationCode')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
...
var $author$project$Main$displayCallGetWorkflows = F2(
	function (op, display) {
		var displayMode = _Utils_eq(op.operationId, -1) ? 'none' : 'block';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$CallGetWorkflows)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Publication Workflows ' + $author$project$Main$fromBoolToString(display))
						]))
				]));
	});
var $author$project$Main$CallGetTasks = {$: 'CallGetTasks'};
var $author$project$Main$displayCallTasks = F2(
	function (op, display) {
		var displayMode = _Utils_eq(op.operationId, -1) ? 'none' : 'block';
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$CallGetTasks)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Tasks ' + $author$project$Main$fromBoolToString(display))
						]))
				]));
	});
var $author$project$Main$displayMenu = F3(
	function (op, isDispTask, isDispWorkflow) {
		var displayMode = _Utils_eq(op.operationId, -1) ? 'none' : 'block';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Main$displayCallTasks, op, isDispTask)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									A2($author$project$Main$displayCallGetWorkflows, op, isDispWorkflow)
								]))
						]))
				]));
	});
var $author$project$Main$displayMessageUser = function (message) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				(message === '') ? $elm$html$Html$text(message) : A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
...
var $author$project$Main$displayOperation = function (o) {
	var displayMode = _Utils_eq(o.operationId, -1) ? 'none' : 'block';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('OperationId')
									])),
								A2(
								$elm$html$Html$td,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(o.operationId))
									]))
							])),
						A2(
						$elm$html$Html$tr,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('OperationCode')
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text(o.operationCode)
									]))
							])),
						A2(
						$elm$html$Html$tr,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Master Mode')
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text(o.masterMode)
									]))
							]))
					]))
			]));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(messageNoTask)
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('master_mode')
													])),
												A2(
												$elm$html$Html$td,
												_List_fromArray(
												...
												_List_fromArray(
													[
														$elm$html$Html$text(t.master_mode)
													]))
											])),
										A2(
										$elm$html$Html$tr,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('user_validator')
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(t.user_validator)
													]))
											])),
										A2(
										$elm$html$Html$tr,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('processed_by')
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(t.processed_by)
													]))
											])),
										A2(
										$elm$html$Html$tr,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('reprise_type')
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(t.reprise_type)
													]))
											])),
										A2(
										$elm$html$Html$tr,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('creation_date')
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(t.creation_date)
													]))
											])),
										A2(
										$elm$html$Html$tr,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('modification_date')
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(t.modification_date)
													]))
											]))
									]));
						},
...
var $author$project$Main$CallAbortWorkflow = function (a) {
	return {$: 'CallAbortWorkflow', a: a};
};
...
var $author$project$Main$getLastWorkflow = function (w) {
	var _v0 = $elm$core$List$head(w);
	if (_v0.$ === 'Just') {
		var justWorkflow = _v0.a;
		return justWorkflow;
	} else {
		return $author$project$Main$emptyWorkflow;
	}
};
	...
	function (workflows, display, operationCode) {
		var workflowsSortedByStarted = $elm$core$List$reverse(
			A2(
				...
				workflows));
		var lastWorkflow = $author$project$Main$getLastWorkflow(workflowsSortedByStarted);
		var messageNoWorkflow = (lastWorkflow.id === '-1') ? 'No workflow found' : '';
		var displayMode = display ? 'block' : 'none';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(messageNoWorkflow)
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('PUBLICATION WORKFLOWS')
													])),
												A2(
												$elm$html$Html$td,
												_List_fromArray(
												...
												_List_fromArray(
													[
														(_Utils_eq(w.id, lastWorkflow.id) && ((w.status !== 'ABORTED') && (w.status !== 'ENDED'))) ? A2(
														$elm$html$Html$button,
														_List_fromArray(
															[
																$elm$html$Html$Events$onClick(
														...
														_List_fromArray(
															[
																$elm$html$Html$text('Abort this Publication')
															])) : $elm$html$Html$text('')
													]))
											])),
										A2(
...
var $author$project$Main$getLastTask = function (t) {
	var _v0 = $elm$core$List$head(t);
	if (_v0.$ === 'Just') {
		var justTask = _v0.a;
		return justTask;
	} else {
