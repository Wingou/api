				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'Value',
							$elm$json$Json$Encode$string('Aborted'))
						]))),
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'CallGetWorkflows':
				var _v2 = model.displayWorkflows;
				if (!_v2) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{displayTasks: false, displayWorkflows: true}),
...
var $author$project$Main$displayTasks = F2(
	function (tasks, display) {
		var lastTask = $author$project$Main$getLastTask(tasks);
	...
	function (workflows, display) {
		...
		var displayMode = function () {
			if (!display) {
				...
				return (lastWorkflow.id === '-1') ? 'none' : 'block';
			}
		}();
		return A2(
			$elm$html$Html$div,
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(model.operationInput),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$Main$displayCallTasks, model.op, model.displayTasks)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A2($author$project$Main$displayCallGetWorkflows, model.op, model.displayWorkflows)
							]))
					])),
				A3(
